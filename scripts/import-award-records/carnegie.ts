...
async function main() {
  ...
  await writeRawAwardRecords("carnegie.json", records, {
    ...
    source: "MediaWiki wikitable for Andrew Carnegie Medals nonfiction winners and finalists",
    notes: "The official ALA/RUSA Carnegie Medals pages are retained in sources/prizes.json, but this first importer uses Wikipedia as a deterministic secondary source.",
    categories: [{
